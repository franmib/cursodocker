                ...
                sshagent(['rodriguezssh']) {
                    ...
                    script{        
                        try{           
                            ...
                            sh 'ssh digesetuser@148.213.1.131 microk8s.kubectl rollout restart deployment fbo_app --kubeconfig=/home/digesetuser/.kube/config'
                            sh 'ssh digesetuser@148.213.1.131 microk8s.kubectl rollout status deployment fbo_app --kubeconfig=/home/digesetuser/.kube/config'          
                        }catch(error)       
                        {}
                    }
                }
